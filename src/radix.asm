...
_final:
	...
	_write:
		...
		mov $file_buffer, %r8
		mov $file_stat,		%RBX
		#add 48(%RBX),		%r8	# Position of size in the struct
		mov 48(%rbx), 		%r12
		mov %r12, %rbx
		
						# now %r8 points to the last index of file_buffer
	...
	mov $file_stat, %rbx		# the total number of bytes in the original file
